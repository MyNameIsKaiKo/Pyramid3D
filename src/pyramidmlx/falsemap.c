...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/07/08 14:35:58 by jleray            #+#    #+#             */
/*   Updated: 2026/07/09 16:39:29 by ldepenne         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	texture_data(t_ctx *ctx)
{
	...
	i = 0;
	paths[0] = ctx->tab_textures[0];
	paths[1] = ctx->tab_textures[1];
	paths[2] = ctx->tab_textures[2];
	paths[3] = ctx->tab_textures[3];
	while (i < 4)
	{
